...
class MultiLayerPerceptron7Predictor(MultiLayerPerceptronPredictor):
    def __init__(self, input_size: int):
        super(MultiLayerPerceptron7Predictor, self).__init__(input_size, 7)

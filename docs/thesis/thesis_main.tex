...
\usepackage[english,dutch]{babel} %Use dutch headings and titles
\usepackage{hyperref}
...
\include{chapters/copyright-thesis}
...
% ------------ summary ----------
\include{abstracts/abstract_dutch}
\include{abstracts/abstract_english}

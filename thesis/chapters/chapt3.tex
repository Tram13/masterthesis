...
\mijnfiguur[H]{width=10cm}{fig/chapt3/verdeling_aantal_reviews_per_restaurant.png}{Histogram aantal reviews per restaurant}{fig:chapt3_verdeling_aantal_reviews_per_restaurant}
